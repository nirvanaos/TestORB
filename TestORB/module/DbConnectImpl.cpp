...
public:
	DbConnectSingleWriterPoolReader (Driver::_ref_type driver,
		...
		pool_ro_ (the_manager->createConnectionPool (driver, url_ro, user, password, 100, 1000, 0))
	{
		create_database ();
	}
...
public:
	DbConnectPool (Driver::_ref_type driver, const IDL::String& url_rwc, const IDL::String& url_ro,
		const IDL::String& user, const IDL::String& password) :
		pool_rw_ (the_manager->createConnectionPool (driver, url_rwc, user, password, 10, 10, 0)),
		pool_ro_ (the_manager->createConnectionPool (driver, url_ro, user, password, 100, 1000, 0))
	{
		create_database ();
	}
