...
class Static_I1_factory_dynamic :
	public servant_traits <I1_factory>::ServantStatic <Static_I1_factory_dynamic>
{
public:
...
NIRVANA_EXPORT_OBJECT (_exp_Test_I1_factory_dynamic, Test::Static_I1_factory_dynamic)
